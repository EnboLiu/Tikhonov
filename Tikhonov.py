...
Announcement, the idea of singular value decomposition follows the

Library of python: InverseProblem-1.0.   License: Vasilaky
...
def gen_invert(A, b, k, l):
    ...
    return(x3)
##This is the solution, X, to AX=b where A is ill-conditioned and b is noisy using a iterative Tikhonov regularization approach.
...
metadata = dict(title='ECG data', artist='Enbo Liu',
...
with writer.saving(fig, "Tikhonov processed video.mp4", 100):
